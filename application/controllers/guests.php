...
class Guests extends CI_Controller {
    ...
    public function index() {
        ...
        if ($search_string !== false && $order !== false || $this->uri->segment(3) == true) {
            ...
            $data['orders'] = $this->orders_model->get_guest_orders('','', '', $order_type, $config['per_page'], $limit_end);
        ...
        //load the view
        $data['main_content'] = 'guests/list';
        $this->load->view('includes/guest_template', $data);
    }
